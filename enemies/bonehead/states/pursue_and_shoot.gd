...
class_name PursueAndShootState

@export var projectile_comp: ProjectileComponent
@export var chase_speed: float = GameConstants.SKELETON_CHASE_SPEED
@export var min_shoot_distance: float = GameConstants.SKELETON_MIN_SHOOT_DISTANCE
