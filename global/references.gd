...
var skeleton_scene: PackedScene = preload("res://characters/enemy/skeleton/skeleton.tscn")
var health_changed_label: PackedScene = preload("res://ui/damage_counter/damage_label.tscn")
var coin_particles: PackedScene = preload("res://effects/coin_particles.tscn")
