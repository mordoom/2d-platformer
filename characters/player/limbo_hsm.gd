...
@onready var riposte_state: LimboState = $Riposte
...
func _init_state_machine() -> void:
    ...
    add_transition(idle_state, riposte_state, &"riposte_started")
    add_transition(riposte_state, idle_state, EVENT_FINISHED)
